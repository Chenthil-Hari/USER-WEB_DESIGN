...
export default function RegisterPage() {
  ...
  const roleConfig: Record<string, any> = {
    user: {
      ...
      icon: '👤',
      title: 'Join as User',
      subtitle: 'Start submitting your projects today',
      accent: 'blue',
      benefits: ['Easy Project Submission', 'Real-time Tracking', 'Budget Management', 'Demo Reviews']
    },
    seller: {
      ...
      accent: 'green',
      benefits: ['Access to Projects', 'Portfolio Building', 'Earn Money', 'Flexible Work']
    },
    admin: {
      ...
      accent: 'purple',
      benefits: ['Full Control', 'Analytics Access', 'User Management', 'System Oversight']
    }
  }
            ...
            <div className="glass p-8 md:p-10 rounded-3xl shadow-2xl border-2 border-white/30 backdrop-blur-xl animate-fadeIn">
              ...
              <div className="mt-6 text-center">
                <p className="text-white/80 mb-2">
                  ...
                  <Link href={`/login/${role}`} className="text-white font-semibold hover:underline">
                    Login here
                  </Link>
                </p>
              </div>
